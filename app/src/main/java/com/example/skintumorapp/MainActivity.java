package com.example.skintumorapp;
...
import android.os.Bundle;
import com.example.skintumorapp.ml.Model;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.SkinImg);
                ...
                if (img != null) {
                    ...
                    try {
                        ...
                        if (outputFeature0.getFloatArray()[0] == 1.0) {
                            output.setText("Yes Skin Tumor");
                        } else {
                            output.setText("No Skin Tumor");
                        }
